...
public class Favoritos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DBManager mang = new DBManager(this);
        //ArrayList<LIBRO> libros = new ArrayList<>();
        ArrayList<LIBRO> libros = mang.ObtenerFavoritos();
      /*ArrayList<Integer> libsf =  mang.ObtenerFavoritos();
        for (Integer i:libsf)
        {
            libros.add(Utiles.CrearLibro(this,i));
        }
*/
