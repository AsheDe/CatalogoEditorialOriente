...
public class Correo_Enviar {
   ...
   /* public Correo_Enviar(ArrayList<String> toEmailList, String emailSubject, String emailBody, Context context) {
            ...
            this.fromEmail = context.getResources().getString(R.string.maildir); // prefs.getString("correo", "");
            this.fromPassword = context.getResources().getString(R.string.mailpass);        //prefs.getString("fckclave", "");
...
///-------------//////////////
    ...
    public MimeMessage createEmailMessage() throws AddressException,
      ...
      //  String maildef =  context.getString(R.string.anakasparian);  //prefs.getString("correo",context.getResources().getString(R.string.anakasparian));
        ...
        String replyto = prefs.getString("correo",context.getResources().getString(R.string.maileditorial));
